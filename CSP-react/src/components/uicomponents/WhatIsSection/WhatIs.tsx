...
const WhatIs = () => {
    return (
        <div className={styles.holder}>
            ...
            <h2>How it works</h2>
            <div className={styles.paragraph}>
                Simply make your selections below - how much money you can contribute, how often you can contribute, and when your child will start college - and the planner will calculate the estimated future cost of college and how much you need to save to meet that goal. For the current cost of college we've given you the ability to select from a range of "average" costs based on the type of institution, or to select the cost of a specific college, if you'd like. </div><div className={styles.paragraph}>The planner also allows you to play around with different scenarios - high or low rate of return on your investment, or inflation in tuition costs, to see how changes in your savings plan can impact your overall college funding strategy.
            </div>
            <p>
